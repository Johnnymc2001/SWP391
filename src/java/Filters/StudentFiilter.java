 ...
 * @author JohnnyMC
 */
public class StudentFiilter implements Filter {
    ...
    public StudentFiilter() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("StudentFiilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("StudentFiilter:DoAfterProcessing");
        }
...
//        System.out.println(url);
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("StudentFiilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("StudentFiilter()");
        }
        StringBuffer sb = new StringBuffer("StudentFiilter(");
